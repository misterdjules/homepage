...
However in the long term and as a software developer I felt that, after a few years, as my gameplay programmer skills sharpened continuously, my general software development skills were declining. There's a lot of different reasons for that, but I'm going to pick three of them that I think can apply to anyone in the industry.

First, AAA games are usually made by a team of hundreds of people, of which several dozens are programmers. Most of the time, gameplay programmers are assigned to a very specific area of the code base, and can keep working on it for a few years. This can significantly reduce the diversity of the types of design and implementation challenges you have to face. 
...
Finally, most libraries, frameworks and tools that developers can use are developed in-house for technical, legal and strategic reasons. This makes the skills acquired by programmers much less transferable to other companies, let alone to other sectors of the IT industry.
...
I was also witnessing the tremendous progress made by developers working in other sectors of the IT industry. It seemed that gameplay programmers were trying to solve the same problems as 15 years ago (pathfinding, collision avoidance, fun combat systems, etc.). On the other hand, I had the impression that progammers in other sectors of the IT industry were using modern tools, programming languages and best practices to solve new problems by experimenting quickly.

It was time to take a step back and determine how I could better match my professional goals with my day to day job.

== Identifying what's important in your career ==

In this section, I present a few key points that I identified as having the biggest impact on how I feel about my work. It is very personal and it could be very different from the way you feel about being a software developer. However, If you find yourself wondering where to push your software development career next, I encourage you to write down a short list of what impacts you most when working. It should give you at least a few clues about which working environment would best match your 
preferences. 

=== Big companies (sometimes) move slowly, technology moves fast ===

Once again, this really resonated with me after having spent 4 years in such a large studio as Ubisoft Montreal, and working in a very specific industry: video games development. Moreover, people who worked in other studios, or even in the same one on the same project as me, have different views about that.

My feeling is that big companies, for a lot of different reasons, tend not to use latest technological advances in software development to their advantage. The reasons are numerous, from too much politics and opiniotated technical managers to development cycles that are too long to allow for rapid changes in their technological stack.

To me, this leads to a degradation of developers' productivity, unpleasant workflows and ultimately, bad morale within developers teams. Additionally for individual developers, it leads to less relevant skillsets over time, and a decrease in value on the jobs market.

=== Work as an artisan rather than as a factory worker ===

Being part of a project where you need to focus only on your specific part of the code base has a lot of advantages, but it can also become very unstimulating, even depressing at times. Depending on your area of expertise, you can find yourself working in such an abstracted and isolated environment that you lose sight of the big picture of what software development is about. To me, this could be analoguous to working on a production line. At one point, the term "industry" in the "video games industry" started to make a lot of sense, and I felt like a production line worker wanting to leave the factory to become more of an artisan.

=== Working in small teams ===

This point is linked to the previous one, because it's more likely that you'll work within a large team if you work in a factory-like environment. I found that being part of a small team exposes you to more diverse challenges: software design, implementation details, operations and deployment, to name a few. It is very likely that, unless your position is at the crossroads of different teams and people, your responsibilities will be much less diverse in a large team.

Working on only one of these aspects of software development can be fun, but I find that working on all of them helps you build the big picture of what it takes to ship complex pieces of software. Of course, it's difficult to scale to several projects if you're involved in so many different areas for each one, which leads me to the next point.
...
=== The ability to work on personal projects that may become business opportunities ===
...
- Accounting solutions: Harvest vs Freshbooks : Harvest because it's cheaper and it's almost equivalent for beginners. Also mention other solutions https://www.waveapps.com/.
